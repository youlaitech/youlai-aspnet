...
/// </summary>
/// <remarks>
/// 提供角色的分页查询、详情、创建、修改、删除以及菜单权限分配等能力
/// </remarks>
[ApiController]
[Route("api/v1/roles")]
[Authorize]
public sealed class RolesController : ControllerBase
{
    ...
    public async Task<PageResult<RolePageVo>> GetRolePage([FromQuery] RolePageQuery queryParams, CancellationToken cancellationToken)
    {
