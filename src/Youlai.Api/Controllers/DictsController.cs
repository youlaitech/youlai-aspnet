...
public sealed class DictsController : ControllerBase
{
    ...
    /// </summary>
    [HttpGet]
    public Task<PageResult<DictPageVo>> GetDictPage([FromQuery] DictPageQuery query, CancellationToken cancellationToken)
    {
    ...
    public Task<PageResult<DictItemPageVo>> GetDictItemPage([FromRoute] string dictCode, [FromQuery] DictItemPageQuery query, CancellationToken cancellationToken)
    {
