...
public sealed class UsersController : ControllerBase
{
    ...
    public Task<PageResult<UserPageVo>> GetUserPage([FromQuery] UserPageQuery query, CancellationToken cancellationToken)
    {
    ...
    public async Task<IActionResult> ExportUsers([FromQuery] UserPageQuery query, CancellationToken cancellationToken)
    {
